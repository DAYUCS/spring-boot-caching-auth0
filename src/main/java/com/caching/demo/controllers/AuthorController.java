...
public class AuthorController {
    ...
    public ResponseEntity<Author> findAuthorById(@PathVariable Integer id) {
        loggingMessage("Read Request received!");
    ...
    public ResponseEntity<Author> replaceAuthorById(@PathVariable Integer id) {
        loggingMessage("Modify Request received!");
        // retrieving the desired data
        Author author = authorService.replaceById(id);
        loggingMessage("Data modified!");
